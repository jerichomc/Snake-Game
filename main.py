...
screen = Screen()
screen.setup(width=600, height=600) #sizes the screen
screen.bgcolor("black") #sets background color
screen.title("Snake") #titles the game/program
...
screen.onkey(snake.down,"Down")  #when one of these buttons is detected, the corresponding method is called
